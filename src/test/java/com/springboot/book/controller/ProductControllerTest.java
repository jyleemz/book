...
import com.springboot.book.service.impl.ProductServiceImpl;
...
public class ProductControllerTest {
    ...
    void createProductTest() throws Exception {
        ...
        given(productService.seveProduct(new ProductDto("pen", 5000, 2000)))
        ...
        verify(productService).seveProduct(new ProductDto("pen", 5000, 2000));
    }
